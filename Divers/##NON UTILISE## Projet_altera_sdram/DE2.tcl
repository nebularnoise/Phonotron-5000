...
if {$make_assignments} {
	...
	set_location_assignment PIN_K25 -to D_from_xil[0]
	set_location_assignment PIN_K26 -to D_from_xil[1]
	set_location_assignment PIN_M22 -to D_from_xil[2]
	set_location_assignment PIN_M23 -to D_from_xil[3]
	set_location_assignment PIN_M19 -to D_from_xil[4]
	set_location_assignment PIN_M20 -to D_from_xil[5]
	set_location_assignment PIN_N20 -to D_from_xil[6]
	set_location_assignment PIN_M21 -to D_from_xil[7]
	set_location_assignment PIN_N24 -to D_to_xil[0]
	set_location_assignment PIN_P24 -to D_to_xil[1]
	set_location_assignment PIN_R25 -to D_to_xil[2]
	set_location_assignment PIN_R24 -to D_to_xil[3]
	set_location_assignment PIN_R20 -to D_to_xil[4]
	set_location_assignment PIN_T22 -to D_to_xil[5]
	set_location_assignment PIN_T23 -to D_to_xil[6]
	set_location_assignment PIN_T24 -to D_to_xil[7]
	set_location_assignment PIN_T20 -to FLAG_OUT
	set_location_assignment PIN_U24 -to RESET_FLAG_OUT
	set_location_assignment PIN_T19 -to FLAG_IN
	set_location_assignment PIN_V25 -to RESET_FLAG_IN
	set_location_assignment PIN_W23 -to SOFT_INIT
