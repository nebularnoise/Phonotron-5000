...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pixel_buffer_dma_ctrlr"
} 
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/pixel_buffer_dma_ctrlr.vhd"
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiv_hssi -L cycloneiv_pcie_hip -L cycloneiv $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiv_hssi -L cycloneiv_pcie_hip -L cycloneiv $TOP_LEVEL_NAME
}
